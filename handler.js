        ...
        for (const user of participants) {
          ...
          try {
            ...
            if (userPrefix && chat.antiArab && botTt.restrict && isBotAdminNn && action === 'add') {
              ...
              m.conn.sendMessage(id, {text: `*[❗] @${user.split('@')[0]} ᴇɴ ᴇsᴛᴇ ɢʀᴜᴘᴏ ɴᴏ sᴇ ᴘᴇʀᴍɪᴛᴇɴ ɴᴜᴍᴇʀᴏs ᴀʀᴀʙᴇs ᴏ ʀᴀʀᴏs, ᴘᴏʀ ʟᴏ ϙᴜᴇ sᴇ ᴛᴇ sᴀᴄᴀʀᴀ ᴅᴇʟ ɢʀᴜᴘᴏ*`, mentions: [user]}, {quoted: fkontak2});
              return;
            }
            m.conn.sendFile(id, apii.data, 'pp.jpg', text, null, false, {mentions: [user]});
          }
        }
      }
      break;

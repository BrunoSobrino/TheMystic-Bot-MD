...
export function serialize() {
  ...
  return Object.defineProperties(proto.WebMessageInfo.prototype, {
    ...
    isBaileys: {
      get() {
        return this.id?.startsWith('3EB0') || false;
    ...
    quoted: {
      get() {
        ...
        return Object.defineProperties(JSON.parse(JSON.stringify(typeof q === 'string' ? {text: q} : q)), {
          ...
          isBaileys: {
            get() {
              return this.id.startsWith('BAE5') && this.id.length === 16 || this.id.startsWith('3EB0') && this.id.length === 12 || this.id.startsWith('3EB0') && (this.id.length === 20 || this.id.length === 22) || this.id.startsWith('B24E') && this.id.length === 20;
	      /*this.id?.length === 16 || this.id?.startsWith('3EB0') && this.id.length === 12 || false;*/
            },
            enumerable: true,
          },

...
function bind(conn) {
  ...
  // Partial<import("baileys").GroupMetadata[]>
  // i really need to fix this
  // returns {id: string, subject: string, metadata: import("baileys").GroupMetadata}
  conn.ev.on('groups.update', updateParticipantsToDb);
  // retrieve contact metadata
  // Partial<import("baileys").Contact>
  // TODO: use for to get all contacts
  conn.ev.on('contacts.update', updateParticipantsToDb);
  // TODO: use the alternative of this chats.update
  ...
  // however its working but can be improved

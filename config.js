...
global.imagen1 = fs.readFileSync('./src/assets/images/menu/main/menu-2.jpg');
global.imagen2 = fs.readFileSync('./src/nuevobot.jpg');
global.imagen3 = fs.readFileSync('./src/Pre Bot Publi.png');
global.imagen4 = fs.readFileSync('./src/assets/images/menu/main/menu-1.png');
global.imagen5 = fs.readFileSync('./src/assets/images/+18.jpg');
global.imagen6 = fs.readFileSync('./src/assets/images/menu/main/menu-3.png');
...
global.fgif = {key: {participant: '0@s.whatsapp.net'}, message: {'videoMessage': {'title': wm, 'h': `Hmm`, 'seconds': '999999999', 'gifPlayback': 'true', 'caption': bottime, 'jpegThumbnail': fs.readFileSync('./src/assets/images/menu/main/menu-1.png')}}};

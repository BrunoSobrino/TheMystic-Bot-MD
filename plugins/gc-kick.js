...
if (responseb[0].status === "200") conn.sendMessage(m.chat, {text: `*@${mentioned.split("@")[0]} ғᴜᴇ ᴇʟɪᴍɪɴᴀᴅᴏ ᴇxɪᴛᴏsᴀᴍᴇɴᴛᴇ ᴅᴇʟ ɢʀᴜᴘᴏ.*`, mentions: [mentioned], contextInfo: { forwardingScore:999, isForwarded:true }}, { quoted: m })  
else if (responseb[0].status === "406") conn.sendMessage(m.chat, {text: `*@${mentioned.split("@")[0]} ᴇs ᴇʟ ᴄʀᴇᴀᴅᴏʀ ᴅᴇʟ ɢʀᴜᴘᴏ, ɴᴏ ᴘᴜᴇᴅᴏ ᴇʟɪᴍɪɴᴀʀ ᴀʟ ᴄʀᴇᴀᴅᴏʀ ᴅᴇʟ ɢʀᴜᴘᴏ*.`, mentions: [mentioned], contextInfo: { forwardingScore:999, isForwarded:true }}, { quoted: m })  
else if (responseb[0].status === "404") conn.sendMessage(m.chat, {text: `@${mentioned.split("@")[0]} ʏᴀ ʜᴀ sɪᴅᴏ ᴇʟɪᴍɪɴᴀᴅᴏ ᴏ ʜᴀ ᴀʙᴀɴᴅᴏɴᴀᴅᴏ ᴇʟ ɢʀᴜᴘᴏ.*`, mentions: [mentioned], contextInfo: { forwardingScore:999, isForwarded:true }}, { quoted: m })

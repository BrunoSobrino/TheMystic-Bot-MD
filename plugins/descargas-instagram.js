...
for (let i = 0; i < img.length; i++) {
  ...
  try {
    ...
    for (const urRRl of datTa) {
      ...
      const tXXxt = `*[ 📥 ] Descargas - Instagram*\n\n▢ *URL:* _${shortUrRRl}_`.trim();
      ...
      try {
        ...
        try {
          ...
          try {
            ...
            const txt1 = `*[ 📥 ] Descargas - Instagram*\n\n▢ *URL:* _${shortUrl1}_`.trim();

...
let text
   ...
   if (text.replace(who, '').join.length > 30) return m.reply('*[❗️] El texto no puede tener mas de 30 caracteres*');
    ...
    const obj = {"type": "quote", "format": "png", "backgroundColor": "#000000", "width": 512, "height": 768, "scale": 2, "messages": [{"entities": [], "avatar": true, "from": {"id": 1, "name": who.name, "photo": {"url": pp}}, "text": text.replace(who, '').join, "replyMessage": {}}]};

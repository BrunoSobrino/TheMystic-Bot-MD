...
global.rpg = {
  ...
  role(level) {
    ...
    const role = [
      { name: 'شخص عادي', level: 0 }, { name: 'متدرب', level: 4 }, { name: 'ماهر', level: 8 }, { name: 'قري تحولي', level: 12 }, { name: 'نصف شيطان', level: 16 },
      { name: 'شيطان كامل', level: 20 }, { name: 'شيطان مائي', level: 24 }, { name: 'شيطان ناري', level: 28 }, { name: 'شيطان ملكي', level: 32 }, { name: 'شيطان خارق', level: 36 },
      { name: 'شيطان هكر', level: 40 }, { name: 'ملك الشياطين', level: 44 }, { name: 'ملاك الصوء', level: 48 }, { name: 'Sorcerer II', level: 52 }, { name: 'ملاك الهواء', level: 56 },
      { name: 'ملاك البحار', level: 60 }, { name: 'ملاك العواصف', level: 64 }, { name: 'Ranger III', level: 68 }, { name: 'ناتسو الطبيعي', level: 72 }, { name: 'ناتسو البرق', level: 76 },
      { name: 'ناتسو الكوني', level: 80 }, { name: 'Mage IV', level: 84 }, { name: 'ناتسو المدمر', level: 88 }, { name: 'Mage II', level: 92 }, { name: 'Mage I', level: 96 },

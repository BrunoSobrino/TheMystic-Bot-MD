...
await conn.sendMessage(m.chat, { video: { url: mediaa.result }, fileName: `error.mp4`, caption: `Hola`, thumbnail: mediaa.thumb, mimetype: 'video/mp4' }, { quoted: m })   
} catch {
let res = await fetch(`https://api.lolhuman.xyz/api/ytplay2?apikey=${lolkeysapi}&query=${text}`)    
let json = await res.json()
await conn.sendFile(m.chat, json.result.video, 'error.mp4', `Hola`, m)}}
} catch (e) {

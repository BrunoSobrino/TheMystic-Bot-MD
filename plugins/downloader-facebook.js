...
await conn.sendMessage(m.chat, { video: { urll }, caption: ress?.meta?.title || '*𝙰𝚀𝚄𝙸 𝙴𝚂𝚃𝙰 𝚂𝚄 𝚅𝙸𝙳𝙴𝙾*' }, { quoted: m })    
break
...
let url3 = json.video
await conn.sendMessage(m.chat, { video: { url3 }, fileName: `error.mp4`, mimetype: 'video/mp4' , caption: '*𝙰𝚀𝚄𝙸 𝙴𝚂𝚃𝙰 𝚂𝚄 𝚅𝙸𝙳𝙴𝙾*' }, { quoted: m })    
break    
...
let vioo = vio.json()
let viooo = json.result.hd.url || json.result.sd.url
await conn.sendMessage(m.chat, { video: { viooo }, fileName: `error.mp4`, mimetype: 'video/mp4' , caption: '*𝙰𝚀𝚄𝙸 𝙴𝚂𝚃𝙰 𝚂𝚄 𝚅𝙸𝙳𝙴𝙾*' }, { quoted: m })
break
}} catch {

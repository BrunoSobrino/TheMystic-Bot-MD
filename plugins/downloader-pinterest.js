...
const handler = async (_0x10bd40, {
  ...
  const _0x5f34cb = _0x4fc489.resource_response.data.results.map((_0x33ba1c) => _0x33ba1c.images.orig.url);
  _0x2af019(_0x5f34cb);
  const _0x3b2637 = _0x5f34cb.splice(0, 5);
  let _0x2913ed = 1;
  for (const _0x47c48a of _0x3b2637) {
    _0x51323f.push({

...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  ...
  const teks = `${tradutor.texto4[0]} wa.me/${await m.sender.split`@`[0]}\n${tradutor.texto4[1]} ${text}\n*┴*`;
  conn.reply('5219992095479@s.whatsapp.net', m.quoted ? teks + m.quoted.text : teks, null, {contextInfo: {mentionedJid: [await m.sender]}});
  conn.reply('584125778026@s.whatsapp.net', m.quoted ? teks + m.quoted.text : teks, null, {contextInfo: {mentionedJid: [await m.sender]}});

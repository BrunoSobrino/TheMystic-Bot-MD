...
const handler = async (m, { conn, usedPrefix, usedPrefix: _p, __dirname, text, isPrems }) => {
  ...
  try {
    ...
    let xov_v = '/.VID-20240813-WA0502.mp4' //حط هنا الفيديو 
...
${tradutor.texto1[9]} ${user.premiumTime > 0 ? '✅' : (isPrems ? '✅' : '❌') || ''}
 ...
 ${tradutor.texto1[10]}
  ...
  ╭───── • ◆ • ─────╮
  ├❧ _${usedPrefix}فديو *<تحميل فديوهات من يوتيوب>*_
  ├❧ _${usedPrefix}شغل *<تحميل اغنيه من.يوتيوب>*_
  ...
  ├❧ _${usedPrefix}تيك *<تحميل فديو من تيك توك برابط>*_
  ├❧ _${usedPrefix}tiktokimg *<url>*_
  ├❧ _${usedPrefix}pptiktok *<usr>*_
  ├❧ _${usedPrefix}mediafire *<url>*_ 
  ├❧ _${usedPrefix}.بين *<تحميل صور بنترست علي شكل لست>*_
 ...
 ${tradutor.texto1[16]}
  ...
  ╰───── • ◆ • ─────╯`
    ...
    if (m.isGroup) {
      await conn.sendFile(m.chat, xov_v, 'menu.mp3', null, m, true, { type: 'audioMessage', ptt: true})
...
handler.command = /^(menu|اوامر|مهام|help|info|comandos|allmenu|2help|menu1.2|ayuda|commands|commandos|cmd)$/i;
handler.exp = 50;
handler.fail = null;

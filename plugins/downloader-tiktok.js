...
await conn.sendMessage(m.chat, { video: { url: dataF.play }, caption: desc1, footer: wm, buttons }, { quoted: m })  
} catch (e1) {
try {
const tTiktok = await tiktokdlF(args[0])
let desc2 = `🔗 *Url:* ${tTiktok.video}`    
await conn.sendMessage(m.chat, { video: { url: tTiktok.video }, caption: desc2, footer: wm, buttons }, { quoted: m })      
} catch (e2) {
try {

...
let handler = async (m, {
  ...
  if (args.length >= 1) {
    ...
    text = m.quoted.text
  } else return m.reply("معك المساعد الذكي الخاص بغوغل اسمي Bard يمكنك ان تسألني ما تشاء مثال :\n\n*.bard* متى يحتفل المغاربة بذكرى المسيرة الخضراء ?")
  await m.reply(wait)
  try {

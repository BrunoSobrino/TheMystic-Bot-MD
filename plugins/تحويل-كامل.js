...
else throw '*هذا الامر خاص بتحويل صورة او فيديو كامل الى ملصق كامل يعني بدون قص الملصق والنتيجة تكون جميلة بحيث تحصل على ملصق كامل  *'
}}
handler.help = ['stiker (caption|reply media)', 'stiker <url>', 'stikergif (caption|reply media)', 'stikergif <url>']
handler.tags = ['sticker']
handler.command = /^كامل$/i

...
try {
let res = await fetch(`https://api-v2.soundcloud.com/search/tracks?q=${text}&client_id=iZIs9mchVcX5lhVRyQGGAYlNPVldzAoX`)
...
let res2 = await fetch(`https://api.akuari.my.id/downloader/scdl?link=${permalinkUrl}`)

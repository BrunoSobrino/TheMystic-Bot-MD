...
const handler = async (m, {conn, text, participants, args}) => {
  ...
  try {
    ...
    for (const user of participant.filter((item) => item.attrs.error == 403)) {
      ...
      const captionn = `Hola, me Presento, Soy @LxShadow ~ Bot y soy un bot para WhatsApp, alguien del grupo uso el comando para agregarte al grupo perno oude hacerlo, te dejo la invitación para que entres, Te Esperamos! `;

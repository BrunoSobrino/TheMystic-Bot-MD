const handler = async (m, {conn}) => {
  ...
  conn.sendMessage(m.chat, {audio: {url: vn}, ptt: true, mimetype: 'audio/mpeg', fileName: `01J672JMF3RCG7BPJW4X2P94N2.mp3`}, {quoted: m});
};
...
let vn = './src/assets/audio/01J672JMF3RCG7BPJW4X2P94N2.mp3'
conn.sendPresenceUpdate('recording', m.chat)

...
const handler = async (m, { conn, args }) => {
   ...
   let txt = `*[ ℹ️ ] Info - Repositorio*\n\n`;
      ...
      txt += `*[ ℹ️ ] Puedes descargar este repositorio enviando el comando:* _${usedPrefix}gitclone ${json?.html_url || 'https://github.com/BrunoSobrino/TheMystic-Bot-MD'}_`;
...
handler.command = ['script', 'repositorio']

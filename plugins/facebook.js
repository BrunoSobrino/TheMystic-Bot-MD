  ...
  try {
    ...
    try {
      ...
      try {
        ...
        conn.sendFile(m.chat, VIDEO, 'error.mp4', `_*https://wa.me/+212648753294?text=𝐻𝑒𝑦~𝑆𝑚𝑖𝑡𝑄💘*_\n\n`, m);
      } catch (err2) {
        try {

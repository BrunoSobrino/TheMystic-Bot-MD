...
const handler = async (m, { command, usedPrefix, conn, text }) => {
  ...
  try {
    ...
    const apiUrls = [
      ...
      `https://api-brunosobrino.onrender.com/api/ytplay?text=${text}&apikey=q3ibff5tmqf8zjg74is7l`,
        ...
        if (command === 'play.1') { 
          ...
          try {
            if (command === 'play.1') {
              ...
              try {
         if (command === 'play.1') { 
              apiUrl = `https://api-brunosobrino.onrender.com/api/v1/ytmp3?url=${data.resultado.url}&apikey=q3ibff5tmqf8zjg74is7l`;
              mimeType = 'audio/mpeg';
              fileName = 'error.mp3';
              buff = await conn.getFile(apiUrl);          
            } else if (command === 'play.2') { 
              apiUrl = `https://api-brunosobrino.onrender.com/api/v1/ytmp4?url=${data.resultado.url}&apikey=q3ibff5tmqf8zjg74is7l`;
              mimeType = 'video/mp4';
              fileName = 'error.mp4';
              buff = await conn.getFile(apiUrl);        
        }
              ...
              try {
         if (command === 'play.1') { 
              apiUrl = `https://api-brunosobrino.onrender.com/api/v2/ytmp3?url=${data.resultado.url}&apikey=q3ibff5tmqf8zjg74is7l`;
              mimeType = 'audio/mpeg';
              fileName = 'error.mp3';
              buff = await conn.getFile(apiUrl);          
            } else if (command === 'play.2') { 
              apiUrl = `https://api-brunosobrino.onrender.com/api/v2/ytmp4?url=${data.resultado.url}&apikey=q3ibff5tmqf8zjg74is7l`;
              mimeType = 'video/mp4';
              fileName = 'error.mp4';
              buff = await conn.getFile(apiUrl);        
        }
